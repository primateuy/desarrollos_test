...
export class TaxTotalsComponent extends Component {
    ...
    formatData(props) {
        ...
        debugger;
        const currencyFmtOpts = { currencyId: props.record.data.custom_currency_id && props.record.data.custom_currency_id[0] };
...
registry.category("fields").add("custom-account-tax-totals-field", TaxTotalsComponent);
